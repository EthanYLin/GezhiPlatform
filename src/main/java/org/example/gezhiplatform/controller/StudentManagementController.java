...
public class StudentManagementController {
    ...
    public StudentManagementController(StudentManagementService studentManagementService, GradeClassService gradeClassService) {
    ...
    public PageResult<StudentCoverResponse> getStudents(
        ...
        return studentManagementService.getAllStudents(gradeNo, classNo, pageable);
    }
    ...
    public StudentCoverResponse getStudentByStuNo(
        ...
        return studentManagementService.getStudentByStuNo(stuNo);
    }
    ...
    public List<StudentCoverResponse> createStudents(
        ...
        return studentManagementService.addStudents(requests);
    }
    ...
    public StudentCoverResponse updateStudent(
        ...
        return studentManagementService.updateStudent(stuNo, request);
    }
    ...
    public List<StudentCoverResponse> deleteStudents(
        ...
        return studentManagementService.deleteStudents(studentNos);
    }
